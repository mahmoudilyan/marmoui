...
import { Badge, LeadLifecycleFunnel } from '@marmoui/ui';
...
/* 8 · Leads Funnel — 7 stages, rainbow, Poor Data INSIDE the funnel */

export function LeadsFunnelCurrent() {
	return (
		<ChartTile question="Leads funnel" toolbar={<CurrentBadge />}>
			<LeadLifecycleFunnel
				ariaLabel="Leads funnel (current — rainbow, Poor Data inside)"
				statuses={[
					{ label: 'Poor Data', leads: 53, color: RAINBOW[0] },
					{ label: 'Awareness', leads: 110, color: RAINBOW[1] },
					{ label: 'Consideration', leads: 4, color: RAINBOW[2] },
					{ label: 'Decision', leads: 1, color: RAINBOW[3] },
					{ label: 'Conversion', leads: 2, color: RAINBOW[4] },
					{ label: 'Retention', leads: 6, color: RAINBOW[5] },
					{ label: 'Maintenance', leads: 1, color: RAINBOW[6] },
				]}
				qualityFlagLabels={[]}
				useDataColors
				height={280}
