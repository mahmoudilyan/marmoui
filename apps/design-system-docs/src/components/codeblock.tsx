...
export function CodeBlock({
	...
	return (
		<figure
			...
			{...props}
			className={cn(
				inTab ? 'bg-panel -mx-px -mb-px last:rounded-b-xl' : 'py-1 bg-panel rounded-xl',
				keepBackground && 'bg-(--shiki-light-bg) dark:bg-(--shiki-dark-bg)',

				'shiki relative border border-secondary shadow-none outline-none not-prose overflow-hidden text-sm',
				props.className
			)}
		>
			{title ? (
...
export function CodeBlockTabs({ ref, ...props }: ComponentProps<typeof Tabs>) {
	...
	return (
		<Tabs
			...
			{...props}
			className={cn('bg-panel border', !nested && 'my-4', props.className)}
		>
